...
import { PaymentInteractionState, type IMessagingAdapter, type PaymentTerminalConfig } from '../../../src/types/payment';
import { setupSuccessfulPaymentMocks, setupNetworkErrorMocks } from '../../helpers/mocks';
import { createMockAxios, createMockMessaging, createMockConfig } from '../../helpers/fixtures';
...
describe('VivaStrategy', () => {
    ...
    describe('processPayment', () => {
        it('should initiate transaction and wait for success', async () => {
            ...
            expect(onStateChange).toHaveBeenCalledWith(PaymentInteractionState.CONNECTING);
        });
